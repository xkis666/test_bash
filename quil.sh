...
# 独立启动
function run_node() {
    screen -dmS quil bash -c "source /root/.gvm/scripts/gvm && gvm use go1.20.2 && cd ~/ceremonyclient/node && ./release_autorun.sh"
...
function update_script() {
    SCRIPT_PATH="./quil.sh"  # 定义脚本路径
    SCRIPT_URL="https://raw.githubusercontent.com/xkis666/test_bash/main/quil.sh"
...
function main_menu() {
    clear
    echo "脚本由 VastNet 提供，仅内部使用"
    echo "================================================================"
    echo "节点社区 Telegram 群组:https://t.me/vastnet001"
    echo "请选择要执行的操作:"
    echo "1. 安装常规节点"
    echo "2. 查看节点日志"
    echo "3. Mac 节点安装"
